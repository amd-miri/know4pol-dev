...
<section class="main-content">
  ...
  <div class="page-content">
    <div class="ecl-container ecl-u-mv-l">
      ...
      <!-- Generic sections -->
	  <?php if (!empty($tabs) && !empty($page['help']) && !empty($action_links)): ?>
...
<script>document.addEventListener('DOMContentLoaded', function () { ECL.initExpandables('#translations-expand-button'); }); </script>