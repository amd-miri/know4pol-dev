(function (Drupal, $, CKEDITOR) {
  Drupal.behaviors.cvCKEDITOR = {
    attach: function () {
      $(document).bind('clientsideValidationAddCustomOptions', function (e, options, cvInstance) {
        if (!cvInstance.settings.includeHidden) {
          // Do not validate hidden fields. Fix ckeditor instances.
          cvInstance.$form.find('textarea.ckeditor-processed').each(function () {
            var $textarea = $(this);
