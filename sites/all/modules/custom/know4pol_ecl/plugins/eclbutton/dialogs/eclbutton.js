...
CKEDITOR.dialog.add('eclbuttonDialog', function (editor) {
    ...
    return {
                    ...
                    },
                    {
                        ...
                        setup: function (element) {
                            jQuery("#cke_65_select").change(function () {
                                //jQuery for showing and hiding description in dialogue box 
        ...
        onOk: function () {
            ...
            var url = protocol + enterurl;

            if (!this.insertMode) {
                this.element.setText(text);
                this.element.setAttribute('data-cke-saved-href', url);
                this.element.setAttribute('class', buttontype);
            }
            if (this.insertMode) {
                this.element.setHtml('<a href="' + url + '" class="' + buttontype + '">' + text + '</a>');
