 ...
 */
 ...
 $base_url = 'http://knowl4pol-new.dd:8083';  // NO trailing slash!
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_knowl4pol_new_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_knowl4pol_new_dd.inc';
}
// </DDSETTINGS>
//include DRUPAL_ROOT . '/sites/all/modules/reggiani/domain/settings.inc';
